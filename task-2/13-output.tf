...
output "public_subnet_ids" {
  description = "List of public subnet IDs suitable for internet-facing ALB"
  value = [
    aws_subnet.public_zone1.id,
    aws_subnet.public_zone2.id # add more if you create additional public subnets later
  ]
}